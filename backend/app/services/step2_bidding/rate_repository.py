...
class Step1RateRepository:
    ...
    def _ocean_to_step1_row(rate: FreightRate, batch: ImportBatch) -> Step1RateRow:
        return Step1RateRow(
            ...
            thc=_as_decimal(rate.thc),
            doc=_as_decimal(rate.doc),
            lss_20=_as_decimal(rate.lss_20),
            lss_40=_as_decimal(rate.lss_40),
            lss_cic=_as_decimal(rate.lss_cic),
            valid_from=rate.valid_from or batch.effective_from,
            valid_to=rate.valid_to or batch.effective_to,
